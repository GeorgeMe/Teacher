 ...
 */
public class AcceptOrderInteractorImpl implements CommonSingleInteractor {
    private BaseSingleLoadedListener<JsonObject> loadedListener;

    public AcceptOrderInteractorImpl(BaseSingleLoadedListener<JsonObject> loadedListener) {
