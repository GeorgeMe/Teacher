...
public class RechargeInteractorImpl implements CommonSingleInteractor {
    ...
    public RechargeInteractorImpl(BaseSingleLoadedListener<JsonObject> loadedListener) {
        this.loadedListener = loadedListener;
    }

    @Override
    public void getCommonSingleData(JsonObject gson) {
        GsonRequest<JsonObject> gsonRequest = new GsonRequest<JsonObject>(UriHelper.getInstance().recharge(gson), null, new TypeToken<JsonObject>() {
