...
public class ConversationListUICustom extends IMConversationListUI {
    ...
    public View getCustomConversationListTitle(final Fragment fragment,final Context context, LayoutInflater inflater) {
        ...
        RelativeLayout customView = (RelativeLayout) inflater.inflate(R.layout.open_im_custom_conversation_title_bar, new RelativeLayout(context),false);
        customView.setBackgroundColor(Color.parseColor("#097cef"));
        TextView title = (TextView) customView.findViewById(R.id.title_txt);
       // YWIMKit mIMKit = LoginHelper.getInstance().getIMKit();
    ...
    public View getCustomView(Context context, YWConversation conversation, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView = inflater.inflate(R.layout.open_im_conversation_custom_view_item,parent,false);
    ...
    public View getCustomItemView(Fragment fragment, YWConversation conversation, View convertView, int viewType, YWContactHeadLoadHelper headLoadHelper, ViewGroup parent) {
        ...
        if (viewType == type_1){
            ...
            if (convertView == null){
                ...
                convertView = inflater.inflate(R.layout.open_im_custom_conversation_item_1, parent, false);
            ...
            if (conversation.getConversationBody() instanceof YWCustomConversationBody) {
                ...
                if(conversationId.equals(MainActivity.SYSTEM_TRIBE_CONVERSATION)){
                    headLoadHelper.setTribeDefaultHeadView(holder.head);
                    name = "群系统消息";
                }else  if(conversationId.equals(MainActivity.SYSTEM_FRIEND_REQ_CONVERSATION)){
            ...
            if (convertView == null){
                ...
                convertView = inflater.inflate(R.layout.open_im_custom_conversation_item_2, parent, false);
                holder.head = (ImageView) convertView.findViewById(R.id.head);
                holder.unread = (TextView) convertView.findViewById(R.id.unread);
                holder.name = (TextView) convertView.findViewById(R.id.name);
