 ...
 */
public class transactionsResponse extends SugarRecord implements Serializable {
    public int errno;
    public String msg;
    ...
    public transactionsResponse(int errno, String msg, int total_count, List<TransactionsBean> transactions) {
        super();
        this.errno = errno;
        this.msg = msg;
